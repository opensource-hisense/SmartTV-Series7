...
class NET_EXPORT_PRIVATE HttpChunkedDecoder {
 public:
  ...
  // If the last chunk was reached and there is no more data in the buffer,
  // we assume that eof was reached.
  // This is a fix for the case when server does not send terminating CRLF.
