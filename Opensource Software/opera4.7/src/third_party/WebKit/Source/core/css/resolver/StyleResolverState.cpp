    ...
    , m_fontBuilder(document)
{
    ...
    float max_scale = max(document.frameHost()->altDeviceScaleFactor(), document.frameHost()->deviceScaleFactor());
    m_elementStyleResources.setDeviceScaleFactor(max_scale);
}
