...
void LayoutThemeDefault::setCheckboxSize(ComputedStyle& style) const
{
    ...
    const float defaultScale = Platform::current()->themeEngine()->getScale(WebThemeEngine::PartCheckbox);
...
void LayoutThemeDefault::setRadioSize(ComputedStyle& style) const
{
    ...
    const float defaultScale = Platform::current()->themeEngine()->getScale(WebThemeEngine::PartRadio);
