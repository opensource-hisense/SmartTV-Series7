...
public:
    ...
    bool hasBackgroundColor() const { return visitedDependentColor(CSSPropertyBackgroundColor).alpha(); }

    bool hasBackground() const { return hasBackgroundColor() || hasBackgroundImage(); }
    ...
    const AtomicString& inputFormat() const { return rareNonInheritedData->m_inputFormat; }
    // End CSS3 Getters
...
// attribute setter methods
    ...
    void setInputFormat(const AtomicString& f) { SET_VAR(rareNonInheritedData, m_inputFormat, f); }
    // End CSS3 Setters
    ...
    static const AtomicString& initialInputFormat() { return nullAtom; }
