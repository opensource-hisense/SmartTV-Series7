...
{
    RefPtrWillBeMember<DocumentFragment> documentFragment = DocumentFragment::create(this->document());
...
ExecutionContext* HTMLCue::executionContext() const
{
    return m_container->executionContext();
}
