...
static bool isContentEditableElement(HTMLElement* element)
{
    ...
    return contentEditableString == "true" || contentEditableString == "plaintext-only";
}
...
void HTMLElement::defaultEventHandler(Event* event)
{
    ...
    if (isContentEditableElement(this) && event->type() == EventTypeNames::webkitEditableContentChanged) {
...
{
    if (isContentEditableElement(this) && insertionPoint->inDocument()) {
        document().contentEditablesController()->registerContentEditableElement(this);
    }
...
void HTMLElement::removedFrom(ContainerNode* insertionPoint)
{
    if (document().contentEditablesController()->isRegistered(this)) {
        document().contentEditablesController()->unregisterContentEditableElement(this);
    }
